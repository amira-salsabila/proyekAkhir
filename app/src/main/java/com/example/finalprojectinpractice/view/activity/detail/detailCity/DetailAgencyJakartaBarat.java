...
public class DetailAgencyJakartaBarat extends AppCompatActivity {

    public static final String EXTRA_AGENCY_ID_JAKARTA_BARAT = "";
    ...
    private ModelAgencyJakartaBaratResultItem agency;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_agency_jakarta_barat);

        tvAgencyName = findViewById(R.id.detailJakartaBarat_AgencyName);
        tvAgencyType = findViewById(R.id.detailJakartaBarat_AgencyType);
        tvAgencyPhone = findViewById(R.id.detailJakartaBarat_AgencyPhoneNumber);
        tvAgencyAddress = findViewById(R.id.detailJakartaBarat_AgencyAddress);
        tvAgencyCity = findViewById(R.id.detailJakartaBarat_AgencyCity);
        tvAgencyLatitude = findViewById(R.id.detailJakartaBarat_AgencyLatitude);
        tvAgencyLongitude = findViewById(R.id.detailJakartaBarat_AgencyLongitude);

        btnCall = findViewById(R.id.detailJakartaBarat_ButtonCall);
        btnPlace =findViewById(R.id.detailJakartaBarat_ButtonLocation);

        agency = (ModelAgencyJakartaBaratResultItem) getIntent().getExtras().get(EXTRA_AGENCY_ID_JAKARTA_BARAT);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(DetailAgencyJakartaBarat.this, MainActivity.class);
