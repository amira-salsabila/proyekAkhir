...
public class DetailAgencyBandung extends AppCompatActivity {

    public static final String EXTRA_AGENCY_ID = "";
    ...
    private ModelAgencyBandungResultItem agency;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_agency_bandung);

        tvAgencyName = findViewById(R.id.detailBandung_AgencyName);
        tvAgencyType = findViewById(R.id.detailBandung_AgencyType);
        tvAgencyPhone = findViewById(R.id.detailBandung_AgencyPhoneNumber);
        tvAgencyAddress = findViewById(R.id.detailBandung_AgencyAddress);
        tvAgencyCity = findViewById(R.id.detailBandung_AgencyCity);
        tvAgencyLatitude = findViewById(R.id.detailBandung_AgencyLatitude);
        tvAgencyLongitude = findViewById(R.id.detailBandung_AgencyLongitude);

        btnCall = findViewById(R.id.detailBandung_ButtonCall);
        btnPlace = findViewById(R.id.detailBandung_ButtonLocation);

        agency = (ModelAgencyBandungResultItem) getIntent().getExtras().get(EXTRA_AGENCY_ID);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(DetailAgencyBandung.this, MainActivity.class);
