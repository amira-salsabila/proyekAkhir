...
public class ModelAgencyPurwakartaResultItem implements Parcelable {
	...
	@Override
 	public String toString(){
		return 
			"ModelAgencyPurwakartaResultItem{" +
	...
	public ModelAgencyPurwakartaResultItem() {
	}

	protected ModelAgencyPurwakartaResultItem(Parcel in) {
	...
	public static final Parcelable.Creator<ModelAgencyPurwakartaResultItem> CREATOR = new Parcelable.Creator<ModelAgencyPurwakartaResultItem>() {
		@Override
		public ModelAgencyPurwakartaResultItem createFromParcel(Parcel source) {
			return new ModelAgencyPurwakartaResultItem(source);
		}

		@Override
		public ModelAgencyPurwakartaResultItem[] newArray(int size) {
			return new ModelAgencyPurwakartaResultItem[size];
		}
	};
}