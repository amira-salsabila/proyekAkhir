...
public class ModelAgencyJakartaSelatanResultItem implements Parcelable {
	...
	@Override
 	public String toString(){
		return 
			"ModelAgencyJakartaSelatanResultItem{" +
	...
	public ModelAgencyJakartaSelatanResultItem() {
	}

	protected ModelAgencyJakartaSelatanResultItem(Parcel in) {
	...
	public static final Parcelable.Creator<ModelAgencyJakartaSelatanResultItem> CREATOR = new Parcelable.Creator<ModelAgencyJakartaSelatanResultItem>() {
		@Override
		public ModelAgencyJakartaSelatanResultItem createFromParcel(Parcel source) {
			return new ModelAgencyJakartaSelatanResultItem(source);
		}

		@Override
		public ModelAgencyJakartaSelatanResultItem[] newArray(int size) {
			return new ModelAgencyJakartaSelatanResultItem[size];
		}
	};
}