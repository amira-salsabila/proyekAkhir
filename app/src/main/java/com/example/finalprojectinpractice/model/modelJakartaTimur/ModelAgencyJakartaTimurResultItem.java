...
public class ModelAgencyJakartaTimurResultItem implements Parcelable {
	...
	public ModelAgencyJakartaTimurResultItem() {
	}

	protected ModelAgencyJakartaTimurResultItem(Parcel in) {
	...
	public static final Parcelable.Creator<ModelAgencyJakartaTimurResultItem> CREATOR = new Parcelable.Creator<ModelAgencyJakartaTimurResultItem>() {
		@Override
		public ModelAgencyJakartaTimurResultItem createFromParcel(Parcel source) {
			return new ModelAgencyJakartaTimurResultItem(source);
		}

		@Override
		public ModelAgencyJakartaTimurResultItem[] newArray(int size) {
			return new ModelAgencyJakartaTimurResultItem[size];
		}
	};
}