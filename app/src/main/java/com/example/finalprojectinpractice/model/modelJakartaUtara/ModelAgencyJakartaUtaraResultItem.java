...
public class ModelAgencyJakartaUtaraResultItem implements Parcelable {
	...
	@Override
 	public String toString(){
		return 
			"ModelAgencyJakartaUtaraResultItem{" +
	...
	public ModelAgencyJakartaUtaraResultItem() {
	}

	protected ModelAgencyJakartaUtaraResultItem(Parcel in) {
	...
	public static final Parcelable.Creator<ModelAgencyJakartaUtaraResultItem> CREATOR = new Parcelable.Creator<ModelAgencyJakartaUtaraResultItem>() {
		@Override
		public ModelAgencyJakartaUtaraResultItem createFromParcel(Parcel source) {
			return new ModelAgencyJakartaUtaraResultItem(source);
		}

		@Override
		public ModelAgencyJakartaUtaraResultItem[] newArray(int size) {
			return new ModelAgencyJakartaUtaraResultItem[size];
		}
	};
}