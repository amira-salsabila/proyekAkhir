...
public class ModelAllAgenciesResultItem implements Parcelable {
	...
	public ModelAllAgenciesResultItem() {
	}

	protected ModelAllAgenciesResultItem(Parcel in) {
	...
	public static final Parcelable.Creator<ModelAllAgenciesResultItem> CREATOR = new Parcelable.Creator<ModelAllAgenciesResultItem>() {
		@Override
		public ModelAllAgenciesResultItem createFromParcel(Parcel source) {
			return new ModelAllAgenciesResultItem(source);
		}

		@Override
		public ModelAllAgenciesResultItem[] newArray(int size) {
			return new ModelAllAgenciesResultItem[size];
		}
	};
}