...
public class ModelAgencyBandungResultItem implements Parcelable {
	...
	public ModelAgencyBandungResultItem() {
	}

	protected ModelAgencyBandungResultItem(Parcel in) {
	...
	public static final Parcelable.Creator<ModelAgencyBandungResultItem> CREATOR = new Parcelable.Creator<ModelAgencyBandungResultItem>() {
		@Override
		public ModelAgencyBandungResultItem createFromParcel(Parcel source) {
			return new ModelAgencyBandungResultItem(source);
		}

		@Override
		public ModelAgencyBandungResultItem[] newArray(int size) {
			return new ModelAgencyBandungResultItem[size];
		}
	};
}